...
export function Sidebar({ onCompose }: SidebarProps) {
  ...
  // These now just log or could be used for navigation to different sections
  const handleEmailClick = () => {
    console.log("Email section clicked");
  };
  ...
  return (
    ...
    >
      ...
      {/* Bottom Icons - Keep theme toggle here */}
      <M3Stack gap={16 / adjustGapNum} justifyContent="flex-end">
        <M3Stack alignItems={"center"}>
          <M3Badge badgeContent={25} color="error">
            <MdNotifications size={24} />
        ...
        {/* Theme Toggle */}
        <M3Stack alignItems="center">
          <M3IconButton onClick={toggleTheme}>
            {mode === "dark" ? (
              <MdOutlineWbSunny size={24} />
            ) : (
              <FiMoon size={24} />
